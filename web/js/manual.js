...
const SECTIONS = [
  ...
  },
  {
    ...
    blocks: [
      { type: 'steps', items: [
        { t: '店舗情報を入れる', b: '「店舗の管理」→「店舗情報を編集する」。店名・住所・営業時間・料金・雰囲気を埋めます。お客様から見えるカードが一緒に出ます（パソコンでは右側、スマホでは下に出ます）。' },
        { t: 'ハウスルールを設定する', b: '「ルールを編集する」。上部の目次から直したい項目へ飛べます。ベースのルールを選んでから、違うところだけ直すのが早いです。' },
        { t: '自分で試し打ちする', b: '「このルールで試し打ちする」。設定どおりに動くか、公開前に必ず一度確かめてください。' },
        { t: '公開前チェックを埋める', b: '「店舗の管理」に、足りない項目だけが大きく出ます。'
          + 'それぞれに直しに行くボタンが付いているので、そこから埋めてください。全部埋まると公開できます。' },
      ] },
      { type: 'table', head: ['画面', 'できること'], rows: [
        ['店舗の管理', '公開までの進み具合・体験プレイ数・来店数・ルールの違いの数'],
        ['店舗情報を編集する', '店名や料金、店舗写真の差し替え、スタッフ紹介'],
        ['ルールを編集する', 'ハウスルールの設定。設定チェックで、成立しない組み合わせを知らせます。'
          + '自分で保存したルールは、同じ画面から削除もできます'],
      ] },
      { type: 'callout', tone: 'amber', title: '編集キーについて', body:
        '店舗の内容を書き換えられるのは、編集キーを持っている端末だけです。'
        + '運営から受け取ったキーを「店舗情報を編集」の画面で一度貼れば、以後その端末で編集できます。'
        + 'キーは他の人に渡さないでください。' },
    ],
  },
  {
